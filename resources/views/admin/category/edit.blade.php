                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right"><a href="{{ route('admin.category.index') }}" type="button" class="btn btn-primary btn-sm">Gerenciar categorias</a>
                                                ...
                                                <form action="{{ route('admin.category.update',$category->id) }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="name" name="name" maxlength="255" oninput="TitleToSlug()" value="{{ old('name', $category->name) }}" placeholder="Nome da categoria" >
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Descrição da categoria (máximo: 150 caracteres)</label>
                                                                <input type="text" class="form-control" id="description" name="description" maxlength="150" value="{{ old('description', $category->description) }}" placeholder="Descrição da categoria">
                                                            </div>
                                                            <div class="form-group thumb">
                                                                <label>Imagem atual</label><br />
                                                                <img src="{{ url("storage/".$category->image) }}" class="img-fluid" width="300em" height="250em">
                                                            </div>
