                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Editar post - {{ $post->title }}</h5>
                                        <div class="card-header-right"><a href="{{ route('admin.post.index') }}" type="button" class="btn btn-primary btn-sm">Gerenciar posts</a>
                                                ...
                                                <form action="{{ route('admin.post.update',$post->id) }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="title" name="title" maxlength="255" oninput="TitleToSlug()" value="{{ old('title', $post->title) }}" placeholder="Título do post" >
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Descrição do post (máximo: 150 caracteres)</label>
                                                                <input type="text" class="form-control" id="description" name="description" maxlength="150" value="{{ old('description', $post->description) }}" placeholder="Descrição do post">
                                                            </div>
                                                            <label>Slug</label>
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="slug" name="slug"  value="{{ old('slug', $post->slug) }}" maxlength="255" placeholder="o-titulo-do-meu-post">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="mb-3 form-control" id="status" name="status">
                                                                    <option value="1" @if ($post->status== 1) selected @endif>Pública</option>
                                                                    <option value="0" @if ($post->status== 0) selected @endif>Invisível</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group thumb">
                                                                <label>Imagem atual</label><br />
                                                                <img src="{{ url("storage/".$post->image) }}" class="img-fluid" width="300em" height="250em">
                                                            </div>
                                                            ...
                                                            <input type="hidden" id="author_id" name="author_id"  value="{{$post->author_id}}">
